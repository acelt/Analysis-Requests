---
title: "Indicator Report for Piceance-East Douglas Herd Management Area"
subtitle: "Interactive Reporting Using Assessment, Inventory, and Monitoring (AIM) and Landscape Monitoring Framework (LMF)"
author: "A Reporting Tool by USDA-ARS Jornada adapted by BLM NOC" 
date: Sys.Date()
output:
  html_document:
    theme: cosmo
...
```{r set EcologicalSiteId, echo = FALSE}
...
PlotMetadata(dataframe = TDat_LMF) # may consider switching this to a histogram as this is sligtly difficult to read
...
```{r summaryfigures, echo=FALSE, message=FALSE}
# Functional Group
## Interactive
...
for(i in EcologicalSiteIds){
  for(j in SummaryVars){
      FigureList_int[[i]][[j]] <- SummaryFigures_WithAttributes_alt(SpeciesList = SpeciesList, 
...
GHS_list_int <- list()
  for(i in EcologicalSiteIds){
      GHS_list_int[[i]] <- SummaryFigures_WithAttributes_alt(SpeciesList = SpeciesList, 
                                                       Species_plots_ecosite = Species_plots_ecosite,
                                                       EcologicalSite = i,  
...
GHS_list_stat <- list()
  for(i in EcologicalSiteIds){
      GHS_list_stat[[i]] <- SummaryFigures_WithAttributes_alt(SpeciesList = SpeciesList, 
                                                       Species_plots_ecosite = Species_plots_ecosite,
                                                       EcologicalSite = i,  
                                                       SummaryVar = "GrowthHabitSub", 
                                                       Interactive = FALSE,
...
```{r SFG plots grass interactive, fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["GrowthHabitSub"]][["Graminoid"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["GrowthHabitSub"]][["Graminoid"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
```{r SFG plots forb , fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["GrowthHabitSub"]][["Graminoid"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["GrowthHabitSub"]][["Forb"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
```{r nox plots , fig.height = 4 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Noxious"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Noxious"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
```{r species plots grass annual , fig.height = 10  , fig.width = 10 , echo = FALSE, include = TRUE , results = 'asis', message=FALSE}
...
for(i in EcologicalSiteIds_AG){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Graminoid.Annual"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Graminoid.Annual"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Graminoid.Perennial"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Graminoid.Perennial"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
for(i in EcologicalSiteIds_AF){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Forb.Annual"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Forb.Annual"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
for(i in EcologicalSiteIds_PF){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Forb.Perennial"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Species"]][["Forb.Perennial"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["GroundCover"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["GroundCover"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
```{r Gap plot , echo = FALSE , include = TRUE , fig.height = 10 , fig.width= 8, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Gap"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["Gap"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
###
### Interactive
```{r soil stab plot , echo = FALSE , include = TRUE , fig.height = 8 , fig.width = 10, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n####", i, "Ecological Site  \n")
  #print(plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["SoilStability"]], tooltip = "text"), boxmode = "group"))
  plotly::layout(p = plotly::ggplotly(FigureList_int[[i]][["SoilStability"]], tooltip = "text"), boxmode = "group")
  cat("  \n")
}
...
### Static
```{r soil stab plot static , echo = FALSE , include = TRUE , fig.height = 8 , fig.width = 10, results="asis"}
...
## Rangeland Analysis Platform (RAP) estimates

Remotely sensed estimates from the [RAP tool](https://rangelands.page.link/eXZYhdbHDydvy2Bx5)
