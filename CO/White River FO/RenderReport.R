...
MakeMap_alt <- function(EcologicalSiteId, TDat_LMF){
  ...
  Caption <- paste0("Cover Summaries for " , hma_name)
...
WorkingFolder <- "C:/Users/alaurencetraynor/Documents/2021/Analysis/CO/WHFO/HMA/R"
...
#Set your own groups using a csv lookup tableto define grouprs of plots for each PK
Groups <- TRUE
# ANNA HAS PROVIDED A LIST OF PLOTS INLCUDING VERIFIED ECOLOGICAL SITE - WILL NEE TO JOIN TO ESS NAME LIST AND TERRADAT
#Location of group LUT
groups <-read.csv("C:\\Users\\alaurencetraynor\\Documents\\2021\\Analysis\\CO\\WHFO\\HMA\\TerrADat_HMA_for_Analysis.csv", stringsAsFactors = F, as.is=TRUE)

# This is the column header of the group name (uniqueid is currently assumed to be "PrimaryKey")
group_name <- "ES_Number_Verified"

# When using groups of years to compare by, we need to define them:
time_period1 <- c("2011", "2012","2013", "2014","2015")
time_period2 <- c("2016", "2017", "2018", "2019", "2020")
...
# We also need to select features within this feature class
hma_name <- "Piceance-East Douglas"
...
Rmd <- paste0(WorkingFolder, "/", "ESS_Tool_PiceaneceEastDouglasHMA_v4.Rmd", sep = "")

rmarkdown::render(Rmd, 
                  output_file = paste0(WorkingFolder, "/", 
                  hma_name, "_", Sys.Date(), sep = ""))
