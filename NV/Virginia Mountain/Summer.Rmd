...
output_filename <- "VirginiaMtn_summer"
...
```
```{r}
analysis_summer <- analysis
all_points_summer <-  all_points
point_weights_summer <-  point_weights
wgtcat_summary_summer <- wgtcat_summary
```
