---
title: "Owyhee LUP Weighted Analysis"
author: "Alex Traynor"
date: "11.28.22"
output:
  html_document:
...
* Request initiated by Nelson, Jennifer E <jenelson@blm.gov>; Redick, Peggy S <predick@blm.gov>; Ferguson, Jacob (Jake) <jferguson@blm.gov>; Trese, Colleen A <ctrese@blm.gov>, and Davis, Jessa C <jcdavis@blm.gov> on 11/10/2022. Proportional area estimates requested ASAP for the Owyhee FO LUP evaluation.
* Benchmarks were provided by the FO in their MDW as well as work from Jennifer documented here:https://doimspp.sharepoint.com/:f:/r/sites/ext-blm-oc-naim/Shared%20Documents/AIM%20Projects/Terrestrial%20Projects/Idaho/Owyhee%20FO/Analysis?csf=1&web=1&e=YjcV6E
...
output_path <- "C:\\Users\\alaurencetraynor\\Documents\\ID\\outputs"
...
output_filename <- "OFO_LUP"

# The variable in AIM sample designs that contains the unique identifier for each point
aim_idvar <- "PlotID" # since this is a single desing plot id is unique
...
sampled_points_name <- "Benchmarked_points"
...
path_spatial <- "\\\\blm.doi.net\\dfs\\nr\\users\\alaurencetraynor\\My Documents\\Analysis\\ID\\Owyhee Weighted Analysis"

### The filepath to the folder where we have the Excel stuff
path_tabular <- "\\\\blm.doi.net\\dfs\\nr\\users\\alaurencetraynor\\My Documents\\Analysis\\ID\\Owyhee Weighted Analysis"
...
benchmarked_points <- sampled_points_benchmarked@data %>% 
  pivot_longer(wf_baresoil:hq_veg_ARMPA_ARTR2, names_to = "Indicator", values_to = "Condition.Category") %>% 
