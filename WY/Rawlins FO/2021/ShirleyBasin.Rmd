---
title: "Shirley Basin Weighted Analysis"
author: "Alex Traynor"
date: "5/13/2021"
output:
  html_document:
...
* Request initiated by Cheryl Newberry from Rawlins FO on 4/30/2021. Proportional area estimates requested for end of May in the Shirley Basin watershed.
Benchmarks were provided by Cheryl and are consistent with the 'Great Divide' weighted analysis performed in 2018 and lower platte analysis in 2020.
* Benchmark groups are based on crew observations of plant community types on the ground and are reflected in the SDD in the 'Actual Stratum' field.
* Cheryl requested LMF points not be used for analysis as LMF crews do not identify these benchmark groups similarly
* Analysis is focused on sage-grouse habitat and so only plots designated as Wyoming Sage, Saltbush, and Mountain Sage communtities will be used.
