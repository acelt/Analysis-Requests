...
wgtcats_var <- "poststrata_id"

### The filepath to the folder where we have all the spatial data
path_spatial <- "\\blm.doi.net\\dfs\\loc\\EGIS\\ProjectsNational\\AIM\\Terrestrial\\Analysis & Reporting\\Analysis Requests\\WY\\Rawlins FO\\2020\\inputs\\spatial"

### The filepath to the folder where we have the Excel stuff
path_tabular <- "\\blm.doi.net\\dfs\\loc\\EGIS\\ProjectsNational\\AIM\\Terrestrial\\Analysis & Reporting\\Analysis Requests\\WY\\Rawlins FO\\2020\\inputs\\tabular"
